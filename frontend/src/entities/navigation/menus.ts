...
export const navigationMenus: MenuItem[] = [
  {
    ...
    items: [
      ...
      { id: "tops", label: "Blouses & tops", href: "/categories/tops" },
      { id: "pants", label: "Pants", href: "/categories/pants" },
      {
        id: "dresses",
      ...
      { id: "pullovers", label: "Pullovers", href: "/categories/pullovers" },
      { id: "tees", label: "Tees", href: "/categories/tees" },
      { id: "skirts", label: "Shorts & skirts", href: "/categories/skirts" },
    ],
  },
  {
    key: "featured",
